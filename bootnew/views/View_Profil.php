                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="timeline-btn">
                                <a href="#" class="btn btn-primary waves-effect waves-light m-r-10">Suivre</a>
                                <a href="#" class="btn btn-primary waves-effect waves-light">Envoyer le Message</a>
                            </div>
                            ...
                            <div class="social-timeline-left">
                                <div class="card">
                                    <div class="social-profile">
                                        <img class="img-fluid width-100" src="../img/profil/avatar.jpg" alt="">
                                    ...
                                    <div class="card-block social-follower">
                                        ...
                                        <div class="">
                                            <a href="#" class="btn btn-outline-primary waves-effect btn-block"><i class="icofont icofont-ui-user m-r-10"></i> Modifier mon Profil</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-header-text">Mes Fans</h5>
                                    </div>
                                    <div class="card-block user-box">
                                        <div class="media m-b-10">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../img/profil/avatar1.png" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                                <div class="live-status bg-danger"></div>
                                            </a>
                                            <div class="media-body">
                                                <div class="chat-header">Clémentine NZAU</div>
                                                <div class="text-muted social-designation">Licencié en Géo-Politque</div>
                                            </div>
                                        </div>
                                        <div class="media m-b-10">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../img/profil/images (4).jpg" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                                <div class="live-status bg-success"></div>
                                            </a>
                                            <div class="media-body">
                                                <div class="chat-header">Trinity BAFANTA</div>
                                                <div class="text-muted social-designation">Philosophe à l'UPC</div>
                                            </div>
                                        </div>
                                        <div class="media m-b-10">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../img/profil/peter.jpg" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                                <div class="live-status bg-danger"></div>
                                            </a>
                                            <div class="media-body">
                                                <div class="chat-header">Peter BIKAYI</div>
                                                <div class="text-muted social-designation">Pédagogue</div>
                                            </div>
                                        </div>
                                        <div class="media m-b-10">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../img/profil/chimène.jpg" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                                <div class="live-status bg-success"></div>
                                            </a>
                                            <div class="media-body">
                                                <div class="chat-header">Chumène MUANZA</div>
                                                <div class="text-muted social-designation">Analyste Programmeur</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-header-text d-inline-block">Mes Collaborateurs</h5>

                                        <span class="label label-primary f-right"> Contributeurs </span>
                                    </div>
                                    <div class="card-block friend-box">
                                        <img class="media-object img-radius" src="../img/profil/av1.jpg" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/av2.jpg" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/av3.jpg" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/av5.JPG" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/av4.png" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/images (3).jpg" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/chimène.jpg" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                        <img class="media-object img-radius" src="../img/profil/avatar1.png" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="user image">
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-8 col-xs-12 ">
                            ...
                            <div class="card social-tabs">
                                <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Actues</a>
                                        <div class="slide"></div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#about" role="tab">Mes Oeuvres</a>
                                        <div class="slide"></div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#photos" role="tab">Mes Médias</a>
                                        <div class="slide"></div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#friends" role="tab">Mes Fans</a>
                                        <div class="slide"></div>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div class="row timeline-right p-t-35">
                                                    <div class="col-2 col-sm-2 col-xl-1">
                                                        <div class="social-timelines-left">
                                                            <img class="img-radius timeline-icon" src="../img/profil/avatar1.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
                                                        <div class="card">
                                                            <div class="card-block post-timelines">
                                                                ...
                                                                <div class="chat-header f-w-600">Tu viens de Changer ta Photo de profil </div>
                                                                <div class="social-time text-muted">il a 10 minutes déjà...</div>
                                                            </div>
                                                            <img src="../img/profil/avatar.jpg" class="img-fluid width-100" alt="">
                                                            <div class="card-block">
                                                                <div class="timeline-details">
                                                                    <div class="chat-header">Clémentine NZAU a commenté</div>
                                                                    <p class="text-muted">Ma Chérie Ba tikayo ooooo</p>
                                                                </div>
                                                            </div>
                                                            <div class="card-block b-b-theme b-t-theme social-msg">
                                                                <a href="#"> <i class="icofont icofont-heart-alt text-muted"></i><span class="b-r-muted">Tu as (2300) Admirateurs</span> </a>
                                                                <a href="#"> <i class="icofont icofont-comment text-muted"></i> <span class="b-r-muted">avec (1850) Commentaires</span></a>
                                                                <a href="#"> <i class="icofont icofont-share text-muted"></i> <span>Et (1650) Fans qui ont Partager</span></a>
                                                            </div>
                                                            <div class="card-block user-box">
                                                                <div class="p-b-30"> <span class="f-14"><a href="#">Les Commentaires recents sur (1650)</a></span><span class="f-right">de tes Fans</span></div>
                                                                <div class="media m-b-20">
                                                                    <a class="media-left" href="#">
                                                                        <img class="media-object img-radius m-r-20" src="../img/profil/peter.jpg" alt="Generic placeholder image">
                                                                    </a>
                                                                    <div class="media-body b-b-muted social-client-description">
                                                                        <div class="chat-header">Peter BIKAYI a commenté<span class="text-muted"> le 20 Avril 2022 à 01h10</span></div>
                                                                        <p class="text-muted">Ma chérie yo nde oleki bango</p>
                                                                    </div>
                                                                </div>
                                                                <div class="media m-b-20">
                                                                    <a class="media-left" href="#">
...
.social-wallpaper {
    position: relative;
    height:300px;
background: url(../img/profil/couverture.png) no-repeat;
